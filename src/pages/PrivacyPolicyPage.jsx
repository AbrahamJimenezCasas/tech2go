export const PrivacyPolicyPage = () => {
    return (
        <section className="flex flex-col items-center p-6 lg:px-32 2xl:px-40 lg:py-8 min-h-[calc(100svh-5rem)]">
            <h2 className="mb-4 font-display text-electric-violet-800 text-4xl">
                Politica de Privacidad{" "}
            </h2>
            <p className="mb-4">
                El presente Política de Privacidad establece los términos en que
                TECH2GO usa y protege la información que es proporcionada por
            ...
            <h2 className="mt-6 mb-2 font-semibold text-electric-violet-600 text-2xl">
            ...
            <p className="mb-4">
                ...
                cancelados en cualquier momento. TECH2GO está altamente
            ...
            <p className="mb-4">
                ...
                juez con un orden judicial. TECH2GO Se reserva el derecho de
