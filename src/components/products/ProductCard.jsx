...
export const ProductCard = ({ id, name, price, pic }) => {
    ...
    return (
        <Link
            to={`/articulos/${id}`}
            className="group flex flex-col items-center bg-light hover:bg-electric-violet-50 shadow-dark/10 shadow-lg p-4 rounded-2xl transition-colors duration-200"
        >
            <img
                src={
                    pic
                ...
                className="rounded-2xl w-full min-h-3/4 object-cover transition-transform group-hover:-translate-y-1 duration-200"
            />
