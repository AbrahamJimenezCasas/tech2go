...
export const ProductCard = ({ name, price, pic }) => {
    ...
    return (
        <Link>
            <article className="group flex flex-col items-center bg-light hover:bg-electric-violet-50 shadow-dark/10 shadow-lg p-4 rounded-2xl transition-colors duration-200">
                <img
                    src={
                        pic
